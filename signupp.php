				...
				<div id="signup-parent" class="row" style="float:float-right;">
					...
					<center>	
                        <form class="registration" method="POST" action="signups_backend.php">
							...
							<input class="signupff" type="text" name="name" placeholder="Name">
							<input class="signupff" type="date" name="dob" placeholder="Date of Birth">
							<input class="signupff" type="number" name="contact" placeholder="Contact">
							<input type="number" class="signupff" name="orgid" placeholder="Oraganisation Name">
